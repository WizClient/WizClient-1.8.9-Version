...
import WizClient.util.openauth.microsoft.model.request.MinecraftLoginRequest;
import WizClient.util.openauth.microsoft.model.request.XSTSAuthorizationProperties;
import WizClient.util.openauth.microsoft.model.request.XboxLiveLoginProperties;
import WizClient.util.openauth.microsoft.model.request.XboxLoginRequest;
import WizClient.util.openauth.microsoft.model.response.MicrosoftRefreshResponse;
import WizClient.util.openauth.microsoft.model.response.MinecraftLoginResponse;
import WizClient.util.openauth.microsoft.model.response.MinecraftProfile;
import WizClient.util.openauth.microsoft.model.response.MinecraftStoreResponse;
import WizClient.util.openauth.microsoft.model.response.XboxLoginResponse;
