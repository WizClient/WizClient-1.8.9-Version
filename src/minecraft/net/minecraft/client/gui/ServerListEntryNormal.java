...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry
{
    ...
    public void drawEntry2(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY) {
            ...
            field_148302_b.submit(new Runnable()
            {
                public void run()
                {
                    ...
                    catch (UnknownHostException var2)
                    {
                        ...
                        ServerListEntryNormal.this.server.serverMOTD = EnumChatFormatting.DARK_RED + "Can\'t resolve h-ostname";
                    }
        ...
        this.mc.fontRendererObj.drawString(this.server.serverName, 170 + 32 + 3, 100 + 1, 16777215);
        List<String> list = this.mc.fontRendererObj.listFormattedStringToWidth(this.server.serverMOTD, listWidth - 32 - 2);

        for (int i = 0; i < Math.min(list.size(), 2); ++i)
        {
            this.mc.fontRendererObj.drawString((String)list.get(i), 170 + 32 + 3, 100 + 12 + this.mc.fontRendererObj.FONT_HEIGHT * i, 8421504);
        }
        ...
        this.mc.fontRendererObj.drawString(s2, 170 + listWidth - j - 15 - 2, 100 + 1, 8421504);
        int k = 0;
        String s = null;
        int l;
        String s1;
        ...
        Gui.drawModalRectWithCustomSizedTexture(170 + listWidth - 15, 100, (float)(k * 10), (float)(176 + l * 8), 10, 8, 256.0F, 256.0F);
        ...
        {
            this.drawTextureAt(170, 100, this.serverIcon);
        }
        else
        {
            this.drawTextureAt(170, 100, UNKNOWN_SERVER);
        }
