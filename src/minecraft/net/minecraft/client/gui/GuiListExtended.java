...
public abstract class GuiListExtended extends GuiSlot
{
    ...
    protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
    {
    	...
    	//ServerListEntryNormal hypixel = new ServerListEntryNormal(new GuiMultiplayer(), new ServerData("", "2b2t.org", false));
    	
    	//hypixel.drawEntry2(p_180791_2_, mouseXIn, entryID, p_180791_3_, p_180791_4_, mouseXIn, mouseYIn, showSelectionBox);
    	
    	
    	//this.getListEntry(entryID).drawEntry2(entryID, p_180791_2_, p_180791_3_, this.getListWidth(), p_180791_4_, mouseXIn, mouseYIn);
    ...
    public interface IGuiListEntry
    {
        ...
        void drawEntry2(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY);
